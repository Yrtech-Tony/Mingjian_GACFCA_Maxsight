    ...
    public partial class ArbitrationTeam : BaseForm
    {
        ...
        private void btnViewPic_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            */
            ...
            string shopName = dto.ShopName;
            string projectCode = dto.ProjectCode;
            string subjectCode = dto.SubjectCode;
            ...
            DataSet dsCheckType = service.SearchPassReCheckBySubjectCodeAndShopCode(projectCode, subjectCode, shopCode);
            ...
            AnswerSubjectForm a = new AnswerSubjectForm(projectCode,
                subjectCode,
                shopCode, shopName, order, checkType, this.UserInfoDto, examType, "ArbitrationTeam");
            a.ShowDialog();
